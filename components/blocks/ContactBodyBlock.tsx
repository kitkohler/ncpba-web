...
const COPY = {
  ...
  locationSub: "Sierra Nevada foothills",
};
...
export default function ContactBodyBlock(props: Props) {
  const email = props.email ?? COPY.email;
  const location = props.location ?? COPY.location;
